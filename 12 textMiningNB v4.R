...
pos.reviews = VCorpus(DirSource("~/Desktop/Rochester/Course/BA/Reviews/1-pos"))

# now process the negative ones
neg.reviews = VCorpus(DirSource(choose.dir()))
# on a mac
neg.reviews = VCorpus(DirSource("~/Desktop/Rochester/Course/BA/Reviews/2-neg"))
...
#library(caret)
train_control = trainControl(method="cv", number=3, repeats=1)  # generally number = 10, 
# train the model 
