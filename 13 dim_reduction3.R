...
student.survey = read.csv(file = 'student survey.csv')
...
save(clus.coord, file = 'clus.coord.Rda')
rownames(clus.coord)
...
clus.pc = data.frame(cluster=ss.out$cluster,
      ...
      adv = (rowSums(student.survey[rows.used,22:25])/4 -1)*10,
